# Figure 7ef donut plots
# Comparing DEGs from Mac2+ cells from control samples vs homeostatic microglia with
# developmental genes identified in Matcovitch-Natan and Winter et al
...
# Load in DEGs from Mac2+ cells from control samples vs homeostatic microglia 
mac2<-read.csv("mac2_ctrl_vs_homeostatic.csv",header=T)
...
##################
# identify overlapping genes in Mac2+ DEGs that belong to each dev_stage
...
# Plot donut plots for upregulated DEGs
...
#################
# Plot donut plot for downregulated DEGs
