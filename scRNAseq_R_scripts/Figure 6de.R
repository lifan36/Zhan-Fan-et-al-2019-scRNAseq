...
ggsave("Mac2microglia_UP_devstages_overlap.pdf", plot = last_plot(), device = "pdf", path = "",
...
ggsave("Mac2microglia_DN_devstages_overlap.pdf", plot = last_plot(), device = "pdf", path = "",
       scale = 0.8, width = 8, height = 4, units = c("in"),
       dpi = 600, limitsize = FALSE)
