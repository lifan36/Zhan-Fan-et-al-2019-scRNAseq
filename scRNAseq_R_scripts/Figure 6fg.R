# Figure 6fg
# Comparison Mac2- cell DEGs with developmental genes
...
# Load in developmental genes identified in Matcovitch-Natan and Winter et al
setwd("")
...
##################
# calculates overlapping genes in Mac2- cell DEGs that belong to each dev_stage
...
# calculates % of genes in Mac2- cell DEGs that belong to each dev_stage
...
#################
# Plot donut chart for Mac2- DEG downregulated overlapping with dev genes
